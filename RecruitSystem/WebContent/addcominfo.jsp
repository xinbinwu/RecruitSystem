...
<html>
	...
	<body>
					...
					<div class="inner clearfix">
						...
						<div class="pull-right userbox">
							...
							<ul class="user-menu">
								...
								<li>
									<a href="manageResume.action">管理应聘信息</a>
								</li>
								<li>
				...
				<div class="nav-tab">
					<div class="inner">
						<ul class="clearfix" style="margin-left: 485px;">
							<!-- 求职者菜单 start -->
							<li>
								<a class="current" style="font-size: 20px;">添加公司信息</a>
							</li>
		...
		<div class="inner clearfix main-container" id="option-keyword" default-value="职位 公司" value="">
			<!-- 编辑简历开始 -->
			<div class="content pull-left">
				<div id="basic-info">
					<div class="d1" style="margin-left: 390px;">
						<form action="addcom.action" data-tpl="edu" method="post">
							<input type="hidden" class="value-field" name="type" value="edu" protected=1>
							<input type="hidden" class="value-field" name="id" value="0">
							<!--<h3 class="class_head" style="margin-left: 150px;"><span>添加公司信息</span></h3>-->							
							<div class="form-group">
								<label>公司名称</label>
								<input type="text" class="form-control value-field" placeholder="公司名称" name="com_name">
							</div>
							<div class="form-group">
								<label>公司领域</label>
								<input type="text" class="form-control value-field" placeholder="公司领域" name="com_field">
							</div>
							<div class="form-group">
								<label>公司人数</label>
								<input type="text" class="form-control value-field" placeholder="公司人数" name="com_num">
							</div>
							<div class="form-group">
								<label>公司地址</label>
								<input type="text" class="form-control value-field" placeholder="公司地址" name="com_add">
							</div>
							<div class="form-group">
								<label>公司介绍</label>
								<input type="text" class="form-control value-field" placeholder="公司信息" name="com_info">
							</div>

							<div class="operation clearfix">
								<a href="###" class="btn cancel _j_cancel">取消</a>
								<input type="submit" class="btn _j_save" value="保存">
							</div>
						</form>
						<!--</div>-->
