...
<html lang="en">
	...
	<body>
						...
						<div class="nav-search-box clearfix">
							<form method="get" action="/post/search">
								<div class="search-input">
									<input id="keyword" autocomplete="off" name="keyword" type="text" value="" placeholder='' />
		...
		<!-- 模态框（Modal） end-->
		<div class="banner-box banner-bg" id="option-keyword" value="" default-value="标题">
			<div class="inner banner-in">
				<div id="myCarousel" class="carousel slide bannerCarousel" data-interval="false">
					<!-- 轮播（Carousel）指标 -->
					...
					<div class="carousel-inner">
						<div class="item  active ">
							<div class="thumbnail-block clearfix">
								...
								<div class="thumbnail-box">
									<a href="/post/post_detail/12" class="thumbnail">
										<img src="http://www.myjob.com/static/img/default_img/article-7.jpg" alt="" class="article-bg">
								...
								<!-- 显示四个 -->
								<div class="thumbnail-box">
									<a href="/post/post_detail/13" class="thumbnail">
										<img src="http://www.myjob.com/static/img/default_img/article-10.jpg" alt="" class="article-bg">
										<div class="article-title-box">
											<div class="article-title">
								...
								<!-- 显示四个 -->
								<div class="thumbnail-box">
									<a href="/post/post_detail/20" class="thumbnail">
										<img src="http://www.myjob.com/static/img/default_img/article-1.jpg" alt="" class="article-bg">
										<div class="article-title-box">
											<div class="article-title">
								...
								<!-- 显示四个 -->
								<div class="thumbnail-box">
									<a href="/post/post_detail/15" class="thumbnail">
										<img src="http://www.myjob.com/static/img/default_img/article-7.jpg" alt="" class="article-bg">
										<div class="article-title-box">
											<div class="article-title">
						...
						<div class="item ">
							<div class="thumbnail-block clearfix">
								<!-- 显示四个 -->
								<div class="thumbnail-box">
									<a href="/post/post_detail/19" class="thumbnail">
										<img src="http://www.myjob.com/static/img/default_img/article-1.jpg" alt="" class="article-bg">
										<div class="article-title-box">
											<div class="article-title">
								...
								<!-- 显示四个 -->
								<div class="thumbnail-box">
									<a href="/post/post_detail/14" class="thumbnail">
										<img src="http://www.myjob.com/static/img/default_img/article-8.jpg" alt="" class="article-bg">
										<div class="article-title-box">
											<div class="article-title">
								...
								<!-- 显示四个 -->
								<div class="thumbnail-box">
									<a href="/post/post_detail/21" class="thumbnail">
										<img src="http://www.myjob.com/static/img/default_img/article-4.jpg" alt="" class="article-bg">
										<div class="article-title-box">
											<div class="article-title">
								...
								<!-- 显示四个 -->
								<div class="thumbnail-box">
									<a href="/post/post_detail/18" class="thumbnail">
										<img src="http://www.myjob.com/static/img/default_img/article-4.jpg" alt="" class="article-bg">
										<div class="article-title-box">
											<div class="article-title">
       ...
       <div class="pull-left">
         <a href="/post/edit_post/1" class="ico-link question">提问题</a>
         <a href="/post/edit_post/0" class="ico-link article">写文章</a>
       </div>
       <a href="/post/draft_list" class="pull-right ico-link draft">草稿箱</a>
     </h5>
				<h5 class="content-title com-content-title">
             <div class="pull-left">
               <a href="/bbs/index/-1/0" class="content-tab  current " data-id="all-trends">全部动态</a>
               <a href="/bbs/index/-1/1/0" class="content-tab " data-id="tag-trends">标签动态</a>
             </div>
             <div class="pull-right trends-filter-box">
               <div class="deliver-filter-txt trends-filter-txt" id="post_type">所有内容</div>
               <ul class="deliver-filter-box trends-filter-option" id="post_type_list">
				...
				<div class="content-tab-box detail-box" data-id="all-trends" style="display:block;padding:10px;">
					<div class="trends-list" id="post_list">
						...
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/49716" target="_blank" class="pull-left" style="margin-right:15px;">祁娜</a>
									<span class="pull-left">比睿  PHP</span>
									<span class="location pull-right">2017-07-14 18:33:04</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/57049" target="_blank" class="pull-left" style="margin-right:15px;">乌迪尔</a>
									<span class="pull-left">郑州乌迪尔电子商务有限公司  销售代表</span>
									<span class="location pull-right">2017-07-14 16:13:42</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53575" target="_blank" class="pull-left" style="margin-right:15px;">曹灵峰</a>
									<span class="pull-left">华强电子交易网络有限公司  招聘专员</span>
									<span class="location pull-right">2017-07-14 14:43:19</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/54126" target="_blank" class="pull-left" style="margin-right:15px;">覃祖盛</a>
									<span class="pull-left">广州龙浩网络科技有限公司  项目经理</span>
									<span class="location pull-right">2017-07-14 14:43:19</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/54128" target="_blank" class="pull-left" style="margin-right:15px;">张国鹏</a>
									<span class="pull-left">腾讯科技（深圳）有限公司  招聘经理</span>
									<span class="location pull-right">2017-07-14 14:43:19</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/54215" target="_blank" class="pull-left" style="margin-right:15px;">李玉水</a>
									<span class="pull-left">杭州唔爱科技有限公司  hr</span>
									<span class="location pull-right">2017-07-14 14:43:19</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/55397" target="_blank" class="pull-left" style="margin-right:15px;">张影</a>
									<span class="pull-left">中软国际科技服务有限公司苏州分公司  招聘助理</span>
									<span class="location pull-right">2017-07-14 14:43:19</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53688" target="_blank" class="pull-left" style="margin-right:15px;">项逸楼</a>
									<span class="pull-left">北京心向优势信息技术有限公司  招聘经理</span>
									<span class="location pull-right">2017-07-14 14:43:19</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/56993" target="_blank" class="pull-left" style="margin-right:15px;">田海霞</a>
									<span class="pull-left">北京数码视讯科技股份有限公司  hr</span>
									<span class="location pull-right">2017-07-14 14:43:19</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53517" target="_blank" class="pull-left" style="margin-right:15px;">李鑫</a>
									<span class="pull-left">深圳市年代文化传播有限公司  运营部总监</span>
									<span class="location pull-right">2017-07-14 14:43:19</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53709" target="_blank" class="pull-left" style="margin-right:15px;">陈潇亮</a>
									<span class="pull-left">阿里巴巴（中国）有限公司  阿里巴巴高德地图HR</span>
									<span class="location pull-right">2017-07-14 14:43:19</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53510" target="_blank" class="pull-left" style="margin-right:15px;">张梁平</a>
									<span class="pull-left">深圳市卓壮医疗管理有限公司  CEO</span>
									<span class="location pull-right">2017-07-14 14:43:19</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53542" target="_blank" class="pull-left" style="margin-right:15px;">邢东伟</a>
									<span class="pull-left">深圳大数据计算机信息股份有限公司  销售总监</span>
									<span class="location pull-right">2017-07-14 14:43:19</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/55645" target="_blank" class="pull-left" style="margin-right:15px;">潘露</a>
									<span class="pull-left">网易（杭州）网络有限公司  高级客户经理</span>
									<span class="location pull-right">2017-07-14 14:43:19</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/57049" target="_blank" class="pull-left" style="margin-right:15px;">乌迪尔</a>
									<span class="pull-left">郑州乌迪尔电子商务有限公司  销售代表</span>
									<span class="location pull-right">2017-07-12 16:28:38</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/55620" target="_blank" class="pull-left" style="margin-right:15px;">邱燚爽</a>
									<span class="pull-left">百度（中国）有限公司  招聘HR</span>
									<span class="location pull-right">2017-07-12 11:49:11</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/54101" target="_blank" class="pull-left" style="margin-right:15px;">李春威</a>
									<span class="pull-left">广州创思信息技术有限公司  HR</span>
									<span class="location pull-right">2017-07-12 11:49:11</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53904" target="_blank" class="pull-left" style="margin-right:15px;">李杨</a>
									<span class="pull-left">北京三快在线科技有限公司  HR</span>
									<span class="location pull-right">2017-07-12 11:49:11</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/55675" target="_blank" class="pull-left" style="margin-right:15px;">余雨</a>
									<span class="pull-left">便利蜂商贸有限公司  hr</span>
									<span class="location pull-right">2017-07-12 11:49:11</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/55693" target="_blank" class="pull-left" style="margin-right:15px;">冀飞飞</a>
									<span class="pull-left">复华控股有限公司  数据总监</span>
									<span class="location pull-right">2017-07-12 11:49:11</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/54279" target="_blank" class="pull-left" style="margin-right:15px;">叶建凯</a>
									<span class="pull-left">北京瑞友科技股份有限公司  招聘主管</span>
									<span class="location pull-right">2017-07-12 11:49:11</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/54195" target="_blank" class="pull-left" style="margin-right:15px;">张梁</a>
									<span class="pull-left">中软国际（中国）科技有限公司  buhr</span>
									<span class="location pull-right">2017-07-12 11:49:11</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/55457" target="_blank" class="pull-left" style="margin-right:15px;">刘海宁</a>
									<span class="pull-left">广州领壹科技有限公司  高级人力经理</span>
									<span class="location pull-right">2017-07-12 11:49:11</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/54178" target="_blank" class="pull-left" style="margin-right:15px;">诸葛衍昆</a>
									<span class="pull-left">杭州衣科信息技术有限公司  杭州衣科HR</span>
									<span class="location pull-right">2017-07-12 11:49:11</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53626" target="_blank" class="pull-left" style="margin-right:15px;">ye</a>
									<span class="pull-left">中软国际科技服务有限公司  招聘专员</span>
									<span class="location pull-right">2017-07-12 11:49:11</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53659" target="_blank" class="pull-left" style="margin-right:15px;">朱宾</a>
									<span class="pull-left">小米科技有限责任公司  服务器开发lead</span>
									<span class="location pull-right">2017-07-12 11:49:11</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53656" target="_blank" class="pull-left" style="margin-right:15px;">Eric</a>
									<span class="pull-left">上海华钦信息科技股份有限公司  招聘主管</span>
									<span class="location pull-right">2017-07-12 11:49:11</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53857" target="_blank" class="pull-left" style="margin-right:15px;">Esther</a>
									<span class="pull-left">慧与（中国）有限公司上海分公司  招聘专员</span>
									<span class="location pull-right">2017-07-12 09:55:28</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53711" target="_blank" class="pull-left" style="margin-right:15px;">陈潇亮</a>
									<span class="pull-left">阿里巴巴（中国）有限公司  阿里巴巴高德地图HR</span>
									<span class="location pull-right">2017-07-12 09:55:28</span>
								</div>
							</div>
						...
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53898" target="_blank" class="pull-left" style="margin-right:15px;">john</a>
									<span class="pull-left">上海星游文化传媒有限公司  hr</span>
									<span class="location pull-right">2017-07-12 09:55:28</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/55700" target="_blank" class="pull-left" style="margin-right:15px;">白瑞</a>
									<span class="pull-left">呼和浩特市一街科技有限公司  CEO</span>
									<span class="location pull-right">2017-07-12 09:55:28</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/54035" target="_blank" class="pull-left" style="margin-right:15px;">吴凯</a>
									<span class="pull-left">北京三快在线科技有限公司  美团外卖Android负责人</span>
									<span class="location pull-right">2017-07-12 09:55:28</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/55737" target="_blank" class="pull-left" style="margin-right:15px;">Nancy</a>
									<span class="pull-left">印孚瑟斯技术（中国）有限公司杭州分公司  HR</span>
									<span class="location pull-right">2017-07-12 09:55:28</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53952" target="_blank" class="pull-left" style="margin-right:15px;">杜潇然</a>
									<span class="pull-left">北京美洽网络科技有限公司  hr</span>
									<span class="location pull-right">2017-07-12 09:55:28</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53936" target="_blank" class="pull-left" style="margin-right:15px;">吕杨</a>
									<span class="pull-left">成都科讯云网络科技有限公司  CEO</span>
									<span class="location pull-right">2017-07-12 09:55:28</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53852" target="_blank" class="pull-left" style="margin-right:15px;">Sunny</a>
									<span class="pull-left">同方鼎欣科技股份有限公司  招聘助理</span>
									<span class="location pull-right">2017-07-12 09:55:28</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/55625" target="_blank" class="pull-left" style="margin-right:15px;">胡玉婷</a>
									<span class="pull-left">中软国际（上海）科技服务有限公司  招聘主管</span>
									<span class="location pull-right">2017-07-12 09:55:28</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53748" target="_blank" class="pull-left" style="margin-right:15px;">谭军红</a>
									<span class="pull-left">珠海市阿里修网络科技有限公司  人事经理</span>
									<span class="location pull-right">2017-07-12 09:55:28</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53817" target="_blank" class="pull-left" style="margin-right:15px;">Ann</a>
									<span class="pull-left">上海讯锡信息科技有限公司  招聘经理</span>
									<span class="location pull-right">2017-07-12 09:55:28</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/55672" target="_blank" class="pull-left" style="margin-right:15px;">刘女士</a>
									<span class="pull-left">四川宏海银企业管理有限公司  招聘经理</span>
									<span class="location pull-right">2017-07-06 18:27:57</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/55792" target="_blank" class="pull-left" style="margin-right:15px;">卢维成</a>
									<span class="pull-left">飞榴（上海）信息科技有限公司  CTO</span>
									<span class="location pull-right">2017-07-06 18:27:57</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53772" target="_blank" class="pull-left" style="margin-right:15px;">张安权</a>
									<span class="pull-left">重庆人人生活家科技发展有限公司  人力资源总监</span>
									<span class="location pull-right">2017-07-06 18:27:57</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53993" target="_blank" class="pull-left" style="margin-right:15px;">李乃旭</a>
									<span class="pull-left">北京以拉谷网络科技有限公司  Investor</span>
									<span class="location pull-right">2017-07-06 18:27:57</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/55749" target="_blank" class="pull-left" style="margin-right:15px;">丁嘉亮</a>
									<span class="pull-left">上海摩提工房食品有限公司  信息部高级经理</span>
									<span class="location pull-right">2017-07-06 18:27:57</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53595" target="_blank" class="pull-left" style="margin-right:15px;">任海洋</a>
									<span class="pull-left">深圳市租我家科技有限公司  运营总监</span>
									<span class="location pull-right">2017-07-06 18:27:57</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/54233" target="_blank" class="pull-left" style="margin-right:15px;">丁红会</a>
									<span class="pull-left">上海韬源信息技术有限公司  招聘专员</span>
									<span class="location pull-right">2017-07-06 18:27:57</span>
								</div>
							</div>
						</div>
						...
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/53794" target="_blank" class="pull-left" style="margin-right:15px;">边一粟</a>
									<span class="pull-left">北京海誉动想科技股份有限公司  hr</span>
									<span class="location pull-right">2017-07-06 18:27:57</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/55661" target="_blank" class="pull-left" style="margin-right:15px;">徐小姐</a>
									<span class="pull-left">普奥云信息科技（北京）有限公司  hrd</span>
									<span class="location pull-right">2017-07-06 18:27:57</span>
								</div>
							</div>
						</div>
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/55717" target="_blank" class="pull-left" style="margin-right:15px;">shirley</a>
									<span class="pull-left">北京商友软件有限公司  招聘主管</span>
									<span class="location pull-right">2017-07-06 18:27:57</span>
								</div>
							</div>
						</div>
					...
					<div class="hidden" id="more_tpl">
						<div class="trends-item clearfix">
							...
							<div class="trends-text pull-left">
								...
								<div class="trends-text-b clearfix">
									<a href="/post/my_post/{user.uid}" target="_blank" class="pull-left" style="margin-right:15px;">{user.bbs_nickname}</a>
			...
			<div class="content-s pull-right">
				...
				<div class="personnel-box-b">
					<div style="border-bottom:1px dashed #e7e7e7;padding-bottom:10px;">
						<a href="/post/my_attention/1" class="ico-favorite">收藏的文章</a>
						<a href="/post/my_attention/4" class="ico-like">关注的问题</a>
					</div>
			...
			<div class="modal fade" id="infoModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="sso-form community-first" style="display:block;box-shadow:none;padding:0;width:350px;">
								<form style="width:350px">
									<div class="head-img-box" style="background:none;padding:0">
										<div class="head-img">
											<img id="bbs_avatar" src="http://game.myjob.com/static/img/avatar/f-1.png">
											<a href="#" class="head-img-btn _j_upload_img" style="position: absolute">点击更换头像</a>
											<input type="hidden" class="value-field" name="bbs_avatar" value="">
										</div>
									</div>
									<div class="form-group clearfix">
										<div class="input-box">
											<i class="input-ico ico-name"></i>
											<input name="bbs_nickname" type="text" class="form-control" value="" placeholder="昵称">
										</div>
									</div>
									<div class="form-group clearfix">
										<div class="input-box">
											<i class="input-ico ico-comp"></i>
											<input name="bbs_company" type="text" class="form-control" value="" placeholder="公司">
										</div>
									</div>
									<div class="form-group clearfix">
										<div class="input-box">
											<i class="input-ico ico-job"></i>
											<input name="bbs_job" type="text" class="form-control" value="" placeholder="职位">
										</div>
									</div>
									<div class="form-group clearfix">
										<div class="input-box">
											<i class="input-ico ico-status"></i>
											<select name="bbs_status_t" class="select-normal">
												<option value=""></option>
						...
						<div class="modal-body">
							<div class="sso-form community-first" style="display:block;box-shadow:none;padding:0;width:350px;">
								...
								<form style="width:350px">
									<div class="form-group clearfix">
										<div class="input-box">
											<i class="input-ico ico-link"></i>
											<input name="bbs_url" type="text" class="form-control" placeholder="地址" readonly="readonly">
										</div>
									</div>
									<div class="form-group clearfix">
										<div class="input-box">
											<i class="input-ico ico-code"></i>
											<input name="code" type="text" class="form-control" placeholder="邀请码" readonly="readonly">
										</div>
									</div>
			...
			<script type="text/javascript">
				...
				$('#copy-btn').click(function() {
					...
					var textToClipboard = '地址：' + bbs_url + '； 邀请码：' + bbs_code;
					var success = true;
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				$(window).scroll(function() {
					if($(document).scrollTop() >= $(document).height() - $(window).height()) {
						var hasmore = $('#more').attr('more');
						var type = $('#more').attr('type');
						var start = $('#more').attr('start');
						var label = $('#more').attr('label');
						if(hasmore) {
							$.ajax({
								url: '/post/get_post',
								type: 'GET',
								...
								success: function(res) {
									$('#more').attr('more', res.data.hasmore);
									$('#more').attr('start', res.data.start);
									if(JSON.stringify(res.data.list) != '{}') {
										var more_tpl = $('#more_tpl').html();
										var more_post = tplReplace(more_tpl, res.data.list);
										$('#post_list').append(more_post);
									}
								}
							});
						}
			...
			function tplReplace(html, data) {
				...
				for(var i = 0; i < data.length; i++) {
					...
					new_html = new_html + html_tpl
						.replace('{id}', data[i].id)
						.replace('{read}', data[i].read)
						.replace('{reply_like}', reply_like)
						.replace('{title}', data[i].title)
						.replace('{user.bbs_nickname}', data[i].user.bbs_nickname)
						.replace('{user.uid}', data[i].user.uid)
						.replace('{user.bbs_company}', data[i].user.bbs_company)
						.replace('{user.bbs_job}', data[i].user.bbs_job)
