		...
		<div class="content pull-left">
			<div id="basic-info">
				<div class="d1" style="margin-left: 390px;">
					<form action="addjob.action" data-tpl="edu" method="post">
						<input type="hidden" class="value-field" name="type" value="edu"
							protected=1> <input type="hidden" class="value-field"
							name="id" value="0">
						<h3 class="class_head" style="margin-left: 150px;">
							<span>添加招聘信息</span>
						</h3>

						<div class="form-group">
							<label>公司名称</label> <input type="text"
								class="form-control value-field" placeholder="公司名称" name="id">
						</div>
						...
						<div class="form-group">
							<label>职位薪水</label> <input type="text"
								...
								name="jobSal" onkeyup="value=value.replace(/[\W]/g,'') ">
						</div>
						<div class="form-group">
