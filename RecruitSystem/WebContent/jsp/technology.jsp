			...
			<div class="nav-tab">
				<div class="inner">
					<ul class="clearfix">
						<!-- 求职者菜单 start -->
						<li><a href="/">首页</a></li>
						<li><a class="current" href="/job/technology">技术职位</a></li>
		...
		<div id="sidebar">
			<div class="mainNavs">
				...
				<div class="menu_box">
					<div class="menu_main">
						<h2>后端开发</h2>
						<a href="/job/search?is_tech=0&keyword=Java">Java</a> <a
							href="/job/search?is_tech=0&keyword=C++">C++</a> <a
							href="/job/search?is_tech=0&keyword=PHP">PHP</a> <a
							href="/job/search?is_tech=0&keyword=数据挖掘">数据挖掘</a> <a
							href="/job/search?is_tech=0&keyword=C">C</a> <a
							href="/job/search?is_tech=0&keyword=C#">C#</a> <a
							href="/job/search?is_tech=0&keyword=.NET">.NET</a> <a
							href="/job/search?is_tech=0&keyword=Hadoop">Hadoop</a> <a
							href="/job/search?is_tech=0&keyword=Python">Python</a> <a
							href="/job/search?is_tech=0&keyword=Delphi">Delphi</a> <a
							href="/job/search?is_tech=0&keyword=VB">VB</a> <a
							href="/job/search?is_tech=0&keyword=Perl">Perl</a> <a
							href="/job/search?is_tech=0&keyword=Ruby">Ruby</a> <a
							href="/job/search?is_tech=0&keyword=Node.js">Node.js</a> <a
							href="/job/search?is_tech=0&keyword=搜索算法">搜索算法</a> <a
							href="/job/search?is_tech=0&keyword=Golang">Golang</a> <a
							href="/job/search?is_tech=0&keyword=自然语言处理">自然语言处理</a> <a
							href="/job/search?is_tech=0&keyword=推荐算法">推荐算法</a> <a
							href="/job/search?is_tech=0&keyword=Erlang">Erlang</a>
					</div>
				</div>
				<div class="menu_box">
					<div class="menu_main">
						<h2>移动开发</h2>
						<a href="/job/search?is_tech=0&keyword=HTML5">HTML5</a> <a
							href="/job/search?is_tech=0&keyword=Android">Android</a> <a
							href="/job/search?is_tech=0&keyword=iOS">iOS</a> <a
							href="/job/search?is_tech=0&keyword=WP">WP</a> <a
							href="/job/search?is_tech=0&keyword=Web前端">Web前端</a> <a
							href="/job/search?is_tech=0&keyword=Flash">Flash</a> <a
							href="/job/search?is_tech=0&keyword=JavaScript">JavaScript</a> <a
							href="/job/search?is_tech=0&keyword=U3D">U3D</a> <a
							href="/job/search?is_tech=0&keyword=COCOS2DX">COCOS2DX</a>
					</div>
				</div>
				<div class="menu_box">
					<div class="menu_main">
						<h2>测试</h2>
						<a href="/job/search?is_tech=0&keyword=测试工程师">测试工程师</a> <a
							href="/job/search?is_tech=0&keyword=自动化测试">自动化测试</a> <a
							href="/job/search?is_tech=0&keyword=功能测试">功能测试</a> <a
							href="/job/search?is_tech=0&keyword=性能测试">性能测试</a> <a
							href="/job/search?is_tech=0&keyword=测试开发">测试开发</a> <a
							href="/job/search?is_tech=0&keyword=移动端测试">移动端测试</a> <a
							href="/job/search?is_tech=0&keyword=游戏测试">游戏测试</a> <a
							href="/job/search?is_tech=0&keyword=硬件测试">硬件测试</a> <a
							href="/job/search?is_tech=0&keyword=软件测试">软件测试</a>
					</div>
				</div>
				<div class="menu_box">
					<div class="menu_main">
						<h2>运维</h2>
						<a href="/job/search?is_tech=0&keyword=运维工程师">运维工程师</a> <a
							href="/job/search?is_tech=0&keyword=运维开发工程师">运维开发工程师</a> <a
							href="/job/search?is_tech=0&keyword=网络工程师">网络工程师</a> <a
							href="/job/search?is_tech=0&keyword=系统工程师">系统工程师</a> <a
							href="/job/search?is_tech=0&keyword=IT支持">IT支持</a> <a
							href="/job/search?is_tech=0&keyword=系统管理员">系统管理员</a> <a
							href="/job/search?is_tech=0&keyword=网络安全">网络安全</a> <a
							href="/job/search?is_tech=0&keyword=系统安全">系统安全</a>
					</div>
				</div>
				<div class="menu_box">
					<div class="menu_main">
						<h2>数据</h2>
						<a href="/job/search?is_tech=0&keyword=MySQL">MySQL</a> <a
							href="/job/search?is_tech=0&keyword=SQLServer">SQLServer</a> <a
							href="/job/search?is_tech=0&keyword=Oracle">Oracle</a> <a
							href="/job/search?is_tech=0&keyword=DB2">DB2</a> <a
							href="/job/search?is_tech=0&keyword=MongoDB">MongoDB</a> <a
							href="/job/search?is_tech=0&keyword=ETLHive">ETLHive</a> <a
							href="/job/search?is_tech=0&keyword=数据仓库">数据仓库</a> <a
							href="/job/search?is_tech=0&keyword=数据开发">数据开发</a> <a
							href="/job/search?is_tech=0&keyword=数据挖掘">数据挖掘</a> <a
							href="/job/search?is_tech=0&keyword=数据处理工程师">数据处理工程师</a> <a
							href="/job/search?is_tech=0&keyword=数据分析师">数据分析师</a> <a
							href="/job/search?is_tech=0&keyword=数据架构师">数据架构师</a>
					</div>
				</div>
				<div class="menu_box">
					<div class="menu_main">
						<h2>项目管理</h2>
						<a href="/job/search?is_tech=0&keyword=项目经理">项目经理</a> <a
							href="/job/search?is_tech=0&keyword=项目主管">项目主管</a> <a
							href="/job/search?is_tech=0&keyword=项目助理">项目助理</a> <a
							href="/job/search?is_tech=0&keyword=项目专员">项目专员</a> <a
							href="/job/search?is_tech=0&keyword=实施顾问">实施顾问</a>
					</div>
				</div>
				<div class="menu_box">
					<div class="menu_main">
						<h2>硬件开发</h2>
						<a href="/job/search?is_tech=0&keyword=硬件">硬件</a> <a
							href="/job/search?is_tech=0&keyword=嵌入式">嵌入式</a> <a
							href="/job/search?is_tech=0&keyword=自动化">自动化</a> <a
							href="/job/search?is_tech=0&keyword=单片机">单片机</a> <a
							href="/job/search?is_tech=0&keyword=电路设计">电路设计</a> <a
							href="/job/search?is_tech=0&keyword=驱动开发">驱动开发</a> <a
							href="/job/search?is_tech=0&keyword=系统集成">系统集成</a> <a
							href="/job/search?is_tech=0&keyword=FPGA开发">FPGA开发</a> <a
							href="/job/search?is_tech=0&keyword=DSP开发">DSP开发</a> <a
							href="/job/search?is_tech=0&keyword=ARM开发">ARM开发</a> <a
							href="/job/search?is_tech=0&keyword=PCB工艺">PCB工艺</a> <a
							href="/job/search?is_tech=0&keyword=模具设计">模具设计</a> <a
							href="/job/search?is_tech=0&keyword=热传导">热传导</a> <a
							href="/job/search?is_tech=0&keyword=材料工程师">材料工程师</a> <a
							href="/job/search?is_tech=0&keyword=精益工程师">精益工程师</a> <a
							href="/job/search?is_tech=0&keyword=射频工程师">射频工程师</a>
					</div>
				</div>
				<div class="menu_box">
					<div class="menu_main">
						<h2>前端开发</h2>
						<a href="/job/search?is_tech=0&keyword=web前端">web前端</a> <a
							href="/job/search?is_tech=0&keyword=Javascript">Javascript</a> <a
							href="/job/search?is_tech=0&keyword=Flash">Flash</a> <a
							href="/job/search?is_tech=0&keyword=HTML5">HTML5</a>
					</div>
				</div>
				<div class="menu_box">
					<div class="menu_main">
						<h2>通信</h2>
						<a href="/job/search?is_tech=0&keyword=通信技术工程师">通信技术工程师</a> <a
							href="/job/search?is_tech=0&keyword=通信研发工程师">通信研发工程师</a> <a
							href="/job/search?is_tech=0&keyword=数据通信工程师">数据通信工程师</a> <a
							href="/job/search?is_tech=0&keyword=移动通信工程师">移动通信工程师</a> <a
							href="/job/search?is_tech=0&keyword=电信网络工程师">电信网络工程师</a> <a
							href="/job/search?is_tech=0&keyword=电信交换工程师">电信交换工程师</a> <a
							href="/job/search?is_tech=0&keyword=有线传输工程师">有线传输工程师</a> <a
							href="/job/search?is_tech=0&keyword=无线射频工程师">无线射频工程师</a> <a
							href="/job/search?is_tech=0&keyword=通信电源工程师">通信电源工程师</a> <a
							href="/job/search?is_tech=0&keyword=通信标准化工程师">通信标准化工程师</a> <a
							href="/job/search?is_tech=0&keyword=通信项目专员">通信项目专员</a> <a
							href="/job/search?is_tech=0&keyword=通信项目经理">通信项目经理</a> <a
							href="/job/search?is_tech=0&keyword=核心网工程师">核心网工程师</a> <a
							href="/job/search?is_tech=0&keyword=通信测试工程师">通信测试工程师</a> <a
							href="/job/search?is_tech=0&keyword=通信设备工程师">通信设备工程师</a> <a
							href="/job/search?is_tech=0&keyword=光通信工程师">光通信工程师</a> <a
							href="/job/search?is_tech=0&keyword=光传输工程师">光传输工程师</a> <a
							href="/job/search?is_tech=0&keyword=光网络工程师">光网络工程师</a>
					</div>
				</div>
				<div class="menu_box">
					<div class="menu_main">
						<h2>高端技术职位</h2>
						<a href="/job/search?is_tech=0&keyword=技术经理">技术经理</a> <a
							href="/job/search?is_tech=0&keyword=技术总监">技术总监</a> <a
							href="/job/search?is_tech=0&keyword=测试经理">测试经理</a> <a
							href="/job/search?is_tech=0&keyword=架构师">架构师</a> <a
							href="/job/search?is_tech=0&keyword=CTO">CTO</a> <a
							href="/job/search?is_tech=0&keyword=运维总监">运维总监</a> <a
							href="/job/search?is_tech=0&keyword=技术合伙人">技术合伙人</a>
					</div>
				</div>
				<div class="menu_box">
					<div class="menu_main">
					...
					<a href="/job/job_detail/30582" target="_blank" class="job-item">
						<div class="job-item-t clearfix">
							<div class="job-item-l pull-left">
								...
								<div class="demand clearfix">
									<span class="star">6k-10k</span> <span>1-3年</span> <span>本科</span>
								</div>
							</div>
							<div class="job-item-c pull-left">
								<div class="com-name">北京鼎恒泰科技有限公司</div>
								<div class="demand clearfix">
									<span>智能硬件</span> <span>未融资</span> <span>20-99人</span>
								</div>
							</div>
							<div class="job-item-r pull-right">
								<div class="com-logo">
									<img
										src="http://game.myjob.com/upload/e/8/e8fe336a35dfc05b18d4cf0437cc5c6f.jpg"
										alt="">
								</div>
							</div>
						</div>
						<div class="job-item-b">
							<span class="location pull-left">北京市 西城区</span> <span
								class="location pull-right">2017-07-17 10:06:27</span>
						</div>
					</a> <a href="/job/job_detail/30594" target="_blank" class="job-item">
						<div class="job-item-t clearfix">
							<div class="job-item-l pull-left">
								<div class="job-name">嵌入式</div>
								<div class="demand clearfix">
									<span class="star">10k-13k</span> <span>1-3年</span> <span>本科</span>
								</div>
							</div>
							<div class="job-item-c pull-left">
								<div class="com-name">首欣（北京）防务科技有限公司</div>
								<div class="demand clearfix">
									<span>非互联网行业</span> <span>未融资</span> <span>0-19人</span>
								</div>
							</div>
							<div class="job-item-r pull-right">
								<div class="com-logo">
									<img
										src="http://game.myjob.com/upload/9/a/9a6824fa6b5f151fa57036d252215c22.jpg"
										alt="">
								</div>
							</div>
						</div>
						<div class="job-item-b">
							<span class="location pull-left">北京市 怀柔区</span> <span
								class="location pull-right">2017-07-17 10:06:27</span>
						</div>
					</a> <a href="/job/job_detail/30595" target="_blank" class="job-item">
						<div class="job-item-t clearfix">
							<div class="job-item-l pull-left">
								<div class="job-name">嵌入式</div>
								<div class="demand clearfix">
									<span class="star">6k-9k</span> <span>1-3年</span> <span>本科</span>
								</div>
							</div>
							<div class="job-item-c pull-left">
								<div class="com-name">首欣（北京）防务科技有限公司</div>
							...
							<div class="job-item-r pull-right">
								<div class="com-logo">
									<img
										src="http://game.myjob.com/upload/6/3/63c8219fb614e57093d68cef3c9056d2.jpg"
										alt="">
								</div>
							</div>
						</div>
						<div class="job-item-b">
							<span class="location pull-left">北京市 大兴区</span> <span
								class="location pull-right">2017-07-17 10:06:27</span>
						</div>
					</a> <a href="/job/job_detail/30567" target="_blank" class="job-item">
						<div class="job-item-t clearfix">
							<div class="job-item-l pull-left">
								<div class="job-name">北京专业培养操盘手+高薪</div>
								<div class="demand clearfix">
									<span class="star">6k-12k</span> <span>1-3年</span> <span>大专</span>
								</div>
							</div>
							<div class="job-item-c pull-left">
								<div class="com-name">大德长成国际投资管理（北京）有限公司</div>
								<div class="demand clearfix">
									<span>金融</span> <span>未融资</span> <span>100-499人</span>
								</div>
							</div>
							<div class="job-item-r pull-right">
								<div class="com-logo">
									<img
										src="http://game.myjob.com/upload/4/e/4e6470b12d170378051d50865af15f58.png"
										alt="">
								</div>
							</div>
						</div>
						<div class="job-item-b">
							<span class="location pull-left">北京市 朝阳区</span> <span
								class="location pull-right">2017-07-11 13:46:27</span>
						</div>
					</a> <a href="/job/job_detail/30566" target="_blank" class="job-item">
						<div class="job-item-t clearfix">
							<div class="job-item-l pull-left">
								<div class="job-name">零基础培训操盘手底薪一万</div>
								<div class="demand clearfix">
									<span class="star">12k-20k</span> <span>3-5年</span> <span>大专</span>
								</div>
							</div>
							<div class="job-item-c pull-left">
								<div class="com-name">大德长成国际投资管理（北京）有限公司</div>
						...
						<div class="job-item-b">
							<span class="location pull-left">北京市 朝阳区</span> <span
								class="location pull-right">2017-07-11 13:42:47</span>
						</div>
					</a> <a href="/job/job_detail/30565" target="_blank" class="job-item">
						<div class="job-item-t clearfix">
							<div class="job-item-l pull-left">
						...
						<div class="job-item-b">
							<span class="location pull-left">北京市 朝阳区</span> <span
								class="location pull-right">2017-07-11 10:44:54</span>
						</div>
					</a> <a href="/job/job_detail/30563" target="_blank" class="job-item">
						<div class="job-item-t clearfix">
							<div class="job-item-l pull-left">
								<div class="job-name">高级JAVA开发工程师</div>
								<div class="demand clearfix">
									<span class="star">20k-25k</span> <span>3-5年</span> <span>本科</span>
								</div>
							</div>
							<div class="job-item-c pull-left">
								<div class="com-name">福建金诚丰担保有限公司北京分公司</div>
						...
						<div class="job-item-b">
							<span class="location pull-left">北京市 朝阳区</span> <span
								class="location pull-right">2017-07-11 10:11:46</span>
						</div>
					</a> <a href="/job/job_detail/30562" target="_blank" class="job-item">
						<div class="job-item-t clearfix">
							<div class="job-item-l pull-left">
						...
						<div class="job-item-b">
							<span class="location pull-left">北京市 朝阳区</span> <span
								class="location pull-right">2017-07-11 10:05:57</span>
						</div>
					</a> <a href="/job/job_detail/30549" target="_blank" class="job-item">
						<div class="job-item-t clearfix">
							<div class="job-item-l pull-left">
								<div class="job-name">带薪6000-18000诚聘期货操盘手</div>
								<div class="demand clearfix">
									<span class="star">6k-18k</span> <span>3-5年</span> <span>本科</span>
								</div>
							</div>
							<div class="job-item-c pull-left">
								<div class="com-name">大德长成国际投资管理（北京）有限公司</div>
						...
						<div class="job-item-b">
							<span class="location pull-left">北京市 朝阳区</span> <span
								class="location pull-right">2017-07-10 11:11:21</span>
						</div>
					</a> <a href="/job/job_detail/30548" target="_blank" class="job-item">
						<div class="job-item-t clearfix">
							<div class="job-item-l pull-left">
								<div class="job-name">北京大望路可模拟考核诚聘外汇交易员</div>
								<div class="demand clearfix">
									<span class="star">8k-10k</span> <span>1-3年</span> <span>大专</span>
								</div>
							</div>
							<div class="job-item-c pull-left">
								<div class="com-name">大德长成国际投资管理（北京）有限公司</div>
						...
						<div class="job-item-b">
							<span class="location pull-left">北京市 朝阳区</span> <span
								class="location pull-right">2017-07-10 11:06:40</span>
						</div>
					</a> <a href="/job/job_detail/30547" target="_blank" class="job-item">
						<div class="job-item-t clearfix">
							<div class="job-item-l pull-left">
								<div class="job-name">年薪50万诚聘操盘手</div>
								<div class="demand clearfix">
									<span class="star">12k-20k</span> <span>1-3年</span> <span>大专</span>
								</div>
							</div>
							<div class="job-item-c pull-left">
								<div class="com-name">大德长成国际投资管理（北京）有限公司</div>
						...
						<div class="job-item-b">
							<span class="location pull-left">北京市 朝阳区</span> <span
								class="location pull-right">2017-07-10 11:04:07</span>
						</div>
					</a> <a href="/job/job_detail/30540" target="_blank" class="job-item">
						<div class="job-item-t clearfix">
							<div class="job-item-l pull-left">
							...
							<div class="job-item-c pull-left">
								...
								<div class="demand clearfix">
									<span>通信</span> <span>未融资</span> <span>1000-9999人</span>
								</div>
							</div>
							<div class="job-item-r pull-right">
								<div class="com-logo">
									<img
										src="http://game.myjob.com/upload/d/3/d3ffab65af5daa467650a524d34f5437.jpg"
										alt="">
								</div>
							</div>
						</div>
						<div class="job-item-b">
							<span class="location pull-left">北京市 西城区</span> <span
								class="location pull-right">2017-07-10 10:56:10</span>
						</div>
					</a> <a href="/job/job_detail/28394" target="_blank" class="job-item">
						<div class="job-item-t clearfix">
							<div class="job-item-l pull-left">
								<div class="job-name">Java工程师</div>
								<div class="demand clearfix">
									<span class="star">1k-2k</span> <span>应届生</span> <span>本科</span>
								</div>
							</div>
							<div class="job-item-c pull-left">
								<div class="com-name">比睿</div>
								<div class="demand clearfix">
									<span>移动互联网</span> <span>A轮</span> <span>20-99人</span>
								</div>
							</div>
							<div class="job-item-r pull-right">
								<div class="com-logo">
									<img
										src="http://game.myjob.com/upload/d/6/d66af67b919feb5a9001b29df663d4d7.jpg"
										alt="">
								</div>
							</div>
						</div>
						<div class="job-item-b">
							<span class="location pull-left">北京市 朝阳区</span> <span
								class="location pull-right">2017-03-01 18:02:21</span>
						</div>
					</a> <a href="/job/job_detail/30506" target="_blank" class="job-item">
						<div class="job-item-t clearfix">
							<div class="job-item-l pull-left">
								<div class="job-name">实施顾问</div>
								<div class="demand clearfix">
									<span class="star">8k-10k</span> <span>1-3年</span> <span>本科</span>
								</div>
							</div>
							<div class="job-item-c pull-left">
							...
							<div class="job-item-r pull-right">
								<div class="com-logo">
									<img
										src="http://game.myjob.com/upload/b/a/ba18ae4aabf12ecb0f796a721967da69.jpg"
										alt="">
								</div>
							</div>
						</div>
						<div class="job-item-b">
							<span class="location pull-left">北京市 门头沟区</span> <span
								class="location pull-right">2017-06-30 18:00:57</span>
						</div>
					</a> <a href="/job/job_detail/30490" target="_blank" class="job-item">
						<div class="job-item-t clearfix">
							<div class="job-item-l pull-left">
								<div class="job-name">项目专员</div>
								<div class="demand clearfix">
									<span class="star">5k-8k</span> <span>应届生</span> <span>本科</span>
								</div>
							</div>
							<div class="job-item-c pull-left">
								<div class="com-name">北京彼岸天下教育咨询有限公司</div>
								<div class="demand clearfix">
									<span>教育培训</span> <span>未融资</span> <span>0-19人</span>
								</div>
							</div>
							<div class="job-item-r pull-right">
								<div class="com-logo">
									<img
										src="http://game.myjob.com/upload/6/2/62ab67d61abb152dd77189437b001cc9.jpg"
										alt="">
								</div>
							</div>
						</div>
						<div class="job-item-b">
							<span class="location pull-left">北京市 通州区</span> <span
								class="location pull-right">2017-06-30 15:37:17</span>
						</div>
					</a>
				</div>
